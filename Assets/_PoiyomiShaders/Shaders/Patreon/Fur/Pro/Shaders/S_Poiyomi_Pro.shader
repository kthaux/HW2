Shader ".poiyomi/Patreon/★ Fur ★"
{
    Properties
    {
        ...
        [HideInInspector] shader_master_label ("<color=#000000ff>Poiyomi Fur V7.2.12</color>", Float) = 0
        ...
        */
        ...
        [ToggleUI] _EnableEmissionCenterOutAudioLink ("Center Out", Float) = 0
        [Enum(Bass, 0, Low Mid, 1, High Mid, 2, Treble, 3)] _AudioLinkEmissionCenterOutBand ("Center Out Band", Int) = 0
        [MultiSlider]_AudioLinkAddEmission ("Add Emission Amount", Vector) = (0, 0, -10, 10)
        [Enum(Bass, 0, Low Mid, 1, High Mid, 2, Treble, 3)] _AudioLinkAddEmissionBand ("Add Emission Band", Int) = 0
        ...
        [ToggleUI] _EnableEmission1CenterOutAudioLink ("Center Out", Float) = 0
        [Enum(Bass, 0, Low Mid, 1, High Mid, 2, Treble, 3)] _AudioLinkEmission1CenterOutBand ("Center Out Band", Int) = 0
        [MultiSlider]_AudioLinkAddEmission1 ("Add Emission Amount", Vector) = (0, 0, -10, 10)
        [Enum(Bass, 0, Low Mid, 1, High Mid, 2, Treble, 3)] _AudioLinkAddEmission1Band ("Add Emission Band", Int) = 0
        ...
        [MultiSlider]_AudioLinkDissolveAlpha ("Dissolve Alpha Mod", Vector) = (0, 0, -1, 1)
        [Enum(Bass, 0, Low Mid, 1, High Mid, 2, Treble, 3)] _AudioLinkDissolveDetailBand ("Dissolve Detail Band", Int) = 0
        [MultiSlider]_AudioLinkDissolveDetail ("Dissolve Detail Mod", Vector) = (0, 0, -1, 1)
        ...
        [Helpbox(1)] _AudioLinkHelp ("This section houses the global controls for audio link. Controls for individual features are in their respective sections. (Emission and Dissolve)", Int) = 0
